...
[![Version](https://img.shields.io/pypi/v/numerary/0.4.0.svg)](https://pypi.org/project/numerary/0.4.0/)
[![Development Stage](https://img.shields.io/pypi/status/numerary/0.4.0.svg)](https://pypi.org/project/numerary/0.4.0/)
[![License](https://img.shields.io/pypi/l/numerary/0.4.0.svg)](http://opensource.org/licenses/MIT)
[![Supported Python Versions](https://img.shields.io/pypi/pyversions/numerary/0.4.0.svg)](https://pypi.org/project/numerary/0.4.0/)
[![Supported Python Implementations](https://img.shields.io/pypi/implementation/numerary/0.4.0.svg)](https://pypi.org/project/numerary/0.4.0/)
...
(See [``beartype.typing``](https://github.com/beartype/beartype/tree/main/beartype/typing) and [``numerary``’s extension](https://github.com/posita/numerary/blob/v0.4.0/numerary/types.py) for details.)
...
## Customers [![``numerary``-encumbered](https://raw.githubusercontent.com/posita/numerary/v0.4.0/docs/numerary-encumbered.svg)](https://posita.github.io/numerary/)
