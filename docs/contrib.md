...
See the ``[options.extras_require]`` section in [``setup.cfg``](https://github.com/posita/numerary/blob/v0.1.1/setup.cfg).
...
* Provide tests where feasible and appropriate.
  ...
  Unit tests live in [``tests``](https://github.com/posita/numerary/tree/v0.1.1/tests).
