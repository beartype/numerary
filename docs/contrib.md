...
See the ``[options.extras_require]`` section in [``setup.cfg``](https://github.com/posita/numerary/blob/v{{ __vers_str__ }}/setup.cfg).
...
* Provide tests where feasible and appropriate.
  ...
  Unit tests live in [``tests``](https://github.com/posita/numerary/tree/v{{ __vers_str__ }}/tests).
